...
const Hero: React.FC = () => {
  return (
    <section
      ...
      style={{
        backgroundImage:
          'linear-gradient(rgba(255, 255, 255, 0.9), rgba(255, 255, 255, 0.8)), url("https://images.unsplash.com/photo-1523473827533-2a64d0d36748?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80")',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7 text-center lg:text-left">
            ...
            <p className="text-lg md:text-xl mb-8 text-gray-700 max-w-2xl mx-auto lg:mx-0">
              Мы предлагаем свежие молочные продукты высочайшего качества прямо
              из нашего подсобного хозяйства в деревне Барково. Каждый день —
              свежее молоко, сметана, творог и сыр.
            </p>
