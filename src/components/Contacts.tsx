      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-gray-600 mb-6">
            Есть вопросы о нашей продукции или хотите сделать заказ? Свяжитесь с нами любым удобным способом.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <div className="flex items-center mt-2 space-x-3">
                    <a href="#" className="text-gray-600 hover:text-[#0088cc] transition-colors">
                      <Icon name="MessageCircle" className="h-6 w-6" title="Telegram" />
                    </a>
                    <a href="#" className="text-gray-600 hover:text-[#4C75A3] transition-colors">
                      <Icon name="AtSign" className="h-6 w-6" title="ВКонтакте" />
                    </a>
                    <a href="#" className="text-gray-600 hover:text-[#25D366] transition-colors">
                      <Icon name="MessageSquare" className="h-6 w-6" title="WhatsApp" />
                    </a>
                  </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            <h3 className="text-2xl font-bold mb-6 text-gray-800">Заказать продукцию</h3>
